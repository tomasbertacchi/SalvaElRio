...
const config: Phaser.Types.Core.GameConfig = {
	...
	scene: [unraf, prepreloader, preloader,idioma, mainmenu, tutorial, informacion, creditos, game, game2,game3, UIscene,UIscene2,UIscene3, menuingame, menuingame2, menuingame3, gananivel, pierdenivel, gananivel2, pierdenivel2, gananivel3, pierdenivel3, creditos2]
}
