...
export default class menuingame extends Phaser.Scene{
    ...
    create(){
        ...
        this.add.text(812, 252, getPhrase("ingamereanudar"){color: "red", fontStyle: "bold", fontFamily: "Courier", fontSize: 65}))
        ...
        this.add.text(865, 753, getPhrase("ingamesalir"){color: "red", fontStyle: "bold", fontFamily: "Courier", fontSize: 65}))
